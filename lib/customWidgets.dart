      ...
      child: Column(
        children: <Widget>[
          ...
          Card(
            ...
            child: InkWell(
              splashColor: c_divi,
              onTap: () => Navigator.pushNamed(context, '/shareloc'),
              child: ListTile(
                leading: Icon(
                  Icons.location_on,
                  size: 0.04 * ht,
...
class headingText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: AutoSizeText(
        heading,
        style: TextStyle(color: color, fontSize: 100, fontFamily: 'Segoe-UI'),
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Padding(
          padding:
              EdgeInsets.symmetric(horizontal: 0.1 * wt, vertical: 0.02 * ht),
          child: Row(
...
class tileWidget extends StatelessWidget {
  ...
  tileWidget(
      String imageN, String popN, String text1, Color tileClr, double tilewt) {
    this.imageN = imageN;
    this.popN = popN;
    this.text1 = text1;
...
class icntileWidget extends StatelessWidget {
  ...
  icntileWidget(IconData iconN, IconData popN, String text1, Color tileClr,
      double tilewt) {
    this.iconN = iconN;
    this.popN = popN;
    this.text1 = text1;
